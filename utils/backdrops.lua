...
local DEFAULT_BACKGROUND = (
    BUILTIN_COLOR_SCHEMES[DEFAULT_COLOR_SCHEME]
    and BUILTIN_COLOR_SCHEMES[DEFAULT_COLOR_SCHEME].background
    or '#24273A'
)
...
---@field focus_color string background color when in focus mode. Default is Catppuccin Macchiato background
...
function BackDrops:init()
    local inital = {
        ...
        focus_color = DEFAULT_BACKGROUND,
        focus_on = false,
    }
...
---Default `focus_color` is Catppuccin Macchiato background
